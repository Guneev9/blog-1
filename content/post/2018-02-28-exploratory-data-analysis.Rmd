...
* Someone might have a preexisting belief that a movie won't be good and upon its release might rate it low because of that belief. Someone who would have been loved the trailer may have a given high rating to the movie, even if thte movie might have actually not been good. This is called **Confirmation Bias**.
...
quarrel with a local store cashier, and tells you how horrible the store is. Would  at a local store, since she and tell you to stay away from itWhen someone asks you to give an estimate, you are most likely to make a guess upon that. (You caught my guess in that statement, didn't you?). You would have heard of someone  However, real world decisions can't be simply made on guess or even an educated guess. The reliability of such an estimate may be questionable  and hence, better methods of estimation need to be used.


rn (CDC) have conducted the National Survey of Family Growth (NSFG), which is intended to gather information on family life, marriage and divorce, pregnancy, infertility, use of contraception, and men's and women's health. The survey results are used to plan health services and health education programs, and to do statistical studies of families, fertility, and health." See http://cdc.gov/nchs/nsfg.htm.
